...
<div class="text-center">
	...
	<P class="mb-2 text-md dark:text-gray-400 sm:px-16" align="center" size="sm">
		The Caesar Cipher is one of the oldest and most famous substitution ciphers. It works very
		simply, only requiring knowledge of the order of the alphabet. You replace every letter in a word with a letter a set distance away from it.
		For example, the word "Barnacle" becomes "Cbsobdmf" after a 1-Right Shift or "Azqmzbkd" after a 1-Left Shift.
	</P>
