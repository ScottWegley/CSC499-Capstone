...
<div class="text-center">
	...
	<div class="mx-auto max-w-screen-2xl">
		<P class="mb-6 text-lg dark:text-gray-400 sm:px-16" align="center" size="sm">
			...
			it under the advisement of Dr. Chang-Shyh Peng, the Computer Science department chair at the
			time, with inspiration from Dr. Craig Reinhart, the former chair and one of my recurring
			professors. I decided to create a webapp primarily because my experience with web development
			is incredibly limited and informal. I plan to end up in Cybersecurity for my career, and that
			requires being familiar with a number of different environments from mobile to desktop to web.
			This seemed the perfect oppurtunity to expose myself to an environment I was less experienced
